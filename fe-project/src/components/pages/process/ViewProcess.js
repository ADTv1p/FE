				...
				<div className="card-body">
					<div className="d-flex justify-content-between align-items-center gap-2 mb-3">
						...
						<div>
							...
							<EditButton className="me-2" size="small" onClick={() => onEditProcess?.(process)}>
								Cập nhật
							</EditButton>
					...
					<div className="mb-3">
						<div className="mb-1">
							<span className="text-white d-inline-block fw-semibold me-2 px-2 rounded" style={{ width: "7em", backgroundColor: "#F1C143", color: "#0E0E0C" }}>
								Tên thao tác:
							</span>
							{process.name}
						</div>
						...
						<div className="text-end">
							<DetailButton className="text-end" onClick={() => navigate(`/quan-ly-nhan-su?process_name=${process.name}`)}>
								Danh sách nhân sự thực hiện thao tác này
							</DetailButton>
						</div>
					</div>
					...
					<div className="mb-3">
						<p className="text-white small mb-0">
							Tạo: {new Date(process.createdAt).toLocaleString()} | Cập nhật:{" "}
